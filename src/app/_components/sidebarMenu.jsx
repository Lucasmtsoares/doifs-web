    ...
    return (
        <>
            {/* --- HEADER/MENU HORIZONTAL --- 
               Aparece em tudo que for MENOR que XL (incluindo o 1024x600)
            */}
            ...
            {/* --- SIDEBAR LATERAL DESKTOP --- 
               Só aparece de XL (1280px) para cima
            */}
            <header className="hidden xl:flex fixed top-0 left-0 h-screen bg-white border-r border-slate-100 flex-col items-center py-6 z-[110] w-72">
                <div className="w-full flex flex-row justify-between items-center mb-8 px-6">
                    <span className="flex-1 font-black text-slate-400 text-[10px] tracking-[0.2em] uppercase">
                        Painel Analytics
                    </span>
