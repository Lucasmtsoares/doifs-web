        ...
        <Card className="rounded-2xl sm:rounded-3xl shadow-sm border-slate-100 bg-white flex flex-col overflow-hidden transition-all hover:shadow-md">
            ...
            <CardFooter className="flex-col gap-4 border-t border-slate-50 bg-slate-50/20 py-5 sm:py-6 px-6 sm:px-8 mt-auto">
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-2 font-black text-slate-800 text-sm sm:text-base">
                        {total.toLocaleString('pt-BR')} <span className="text-slate-400 font-medium text-[10px] sm:text-xs uppercase tracking-tighter">Atos Totais</span>
                    </div>
                ...
                <div className="flex flex-wrap justify-center gap-x-3 gap-y-2 pt-4 border-t border-slate-100 w-full">
                    {data.map((item) => (
